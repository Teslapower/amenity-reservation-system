package de.misasoft.amenity_reservation_system.service;
...
import de.misasoft.amenity_reservation_system.model.ReservationDTO;
import de.misasoft.amenity_reservation_system.repos.ReservationRepository;
import de.misasoft.amenity_reservation_system.repos.UserRepository;
...
public class ReservationService {
    ...
    private ReservationDTO mapToDTO(final Reservation reservation,
        ...
        reservationDTO.setReservationData(reservation.getReservationData());
    ...
    private Reservation mapToEntity(final ReservationDTO reservationDTO,
        ...
        reservation.setReservationData(reservationDTO.getReservationData());
